...
import { DjangoRestapiServiceService } from '../../services/django-restapi-service.service';
...
@Component({
  selector: 'app-django-restapi',
  templateUrl: './django-restapi.component.html',
  styleUrls: ['./django-restapi.component.css']
})
export class DjangoRestapiComponent implements OnInit, OnDestroy {
  ...
  constructor(private taskService: DjangoRestapiServiceService) {}
