...
import { JavaSpringBootApiService } from '../../services/java-spring-boot-api.service';
...
@Component({
  ...
  styleUrls: ['./java-spring-boot.component.css']
})
export class JavaSpringBootComponent implements OnInit, OnDestroy {
  ...
  constructor(private userService: JavaSpringBootApiService) {}
